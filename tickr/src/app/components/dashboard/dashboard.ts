...
const testdata: FinancialData = {
  yearlyIncomeStatements: [
    ...
    },
    {
      ...
      ebitda: 123136000000,
      ebit: 111852000000,
      nonOperatingIncomeExcludingInterest: -2903000000,
      ...
      netIncomeDeductions: 0,
      bottomLineNetIncome: 94680000000,
      eps: 5.67,
      epsDiluted: 5.61,
    ...
    },
    {
      ...
      ebitda: 81020000000,
      ebit: 69964000000,
      nonOperatingIncomeExcludingInterest: -3676000000,
      ...
      netIncomeDeductions: 0,
      bottomLineNetIncome: 57411000000,
      eps: 3.31,
      epsDiluted: 3.28,
